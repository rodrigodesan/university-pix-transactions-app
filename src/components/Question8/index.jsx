...
export default function Question8({ years }) {
  ...
  async function search() {
    ...
    setAnswer('');
    try {
      const { data } = await api.question8(year);
  ...
  return (
    <div className="mb-3">
      <p>
        8. Quais as 10 cidades que tiveram maior diferença positiva (valor maior
        entrando que saindo) de pix para um determinado ano?
      </p>
...
Question8.propTypes = yearTypes.isRequired;
